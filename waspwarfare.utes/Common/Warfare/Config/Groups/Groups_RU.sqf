...
_u pushBack "CUP_O_RU_Soldier_AR_M_EMR";
_u pushBack "CUP_O_RU_Soldier_SL_M_EMR";
_u pushBack "CUP_O_RU_Soldier_SL_M_EMR";
_u pushBack "CUP_O_RU_Soldier_LAT_M_EMR";
_u pushBack "CUP_O_RU_Medic_M_EMR";
_l pushBack _u;
