            ...
            case "success": {                
                ...
                if (!isNull(commanderTeam)) then {
                    if (commanderTeam == Group player) then {
                        ...
                        HQAction = leader(group player) addAction [localize "STR_WF_BuildMenu",{call WFCL_fnc_callBuildMenu}, _MHQs, 1000, false, true, "", "hqInRange && canBuildWHQ && (_target == player)"];
                    };
                };
